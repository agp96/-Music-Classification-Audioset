...
parser.add_argument('--num_classes', type=int, default=7, metavar='CLASSES', help='Number of classes.')
...
def process_file(wav_file, num_classes, threshold, first_class, second_class):
    ...
    with WavProcessor() as proc:
        predictions = proc.get_predictions(sr, data, num_classes, threshold, first_class, second_class)
